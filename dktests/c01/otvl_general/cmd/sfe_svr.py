...
from otvl_general.utils import estore_pb2_grpc, stfl_pb2_grpc, ope_pb2_grpc
from otvl_general.utils import (
    estore_server,
    estoredb,
    stfl_server,
    ope_server,
...
def serve(
    ...
    ope_pb2_grpc.add_OpeServicer_to_server(ope_server.Ope(VERSION, Server(server), logger), server)
